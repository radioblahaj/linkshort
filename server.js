...
http.createServer(function (req, res) {
  ...
  function check(url) {
    ...
    if(jsonDB.hasOwnProperty(newKey)){
      ...
      res.write(`${url} is now shortend at https://linkshort.glitch.me/${newKey} `)
    }
  }
  var url = req.url.replace("/", "");
  if(url == "") {
    res.write(`<!DOCTYPE html><html><head><title>LinkShort</title><link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css"><style>body {background-color: #f2f2f2; padding: 70px 0;}</style></head><body><center><h1>URL Shortener</h1><p>A Easier way To Shorten Links</p><hr/><h3>Put a URL, and Get A Shorten Link!</h3> For example: <br/><code class="w3-codespan">https:///linkshort.glitch.me/create/https://www.foo.com</code><b> may return:</b><br/><code class="w3-codespan">https://linkshort.glitch.me/arjh3</code><br/><br/><br/>By using this site, you agree to our <a href="/tos">Terms Of Service</a> | <a href="http://Aravnarula.com">By Arav Narula</a> | <a href="mailto:media.trouge@gmail.com">Email Us</a></center></body></html>`)
